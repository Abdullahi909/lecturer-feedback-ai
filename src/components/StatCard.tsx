...
type Props = {
  ...
  value: string | number;
  icon: LucideIcon;
  iconColor: string; // hex — icon stroke colour
  iconBg: string;   // hex — icon badge background
  note?: string;    // optional small caption below the value
};

// Reusable metric card used on the dashboard and approved pages
